...
contagem regressiva começando em 10
...
nove_digitos = cpf_enviado_usuario[:9]                             # FATIAMENTO POR INDICES
contador_regressivo_1 = 10

resultado_digito_1 = 0
for digito in nove_digitos:
    resultado_digito_1 += int(digito) * contador_regressivo_1    # += soma os resultados de cada laço do for
